...
public class RecyclerViewExtensions {
    ...
    @BindingAdapter({"bind:items", "bind:itemLayout", "bind:itemBindingId", "bind:filterClass"})
    public static void createAdapter(final RecyclerView list, ObservableList items, int itemLayout,
                                     int itemBindingId, SimpleBindingListAdapter.FilterI filterClass) {
        if (null == list.getAdapter()) {
            SimpleBindingListAdapter adapter = new SimpleBindingListAdapter(items, itemBindingId, itemLayout, filterClass);
            final LinearLayoutManager layoutManager = new LinearLayoutManager(list.getContext());
    ...
    @BindingAdapter({
            ...
            "bind:layoutType",
            "bind:spanCount"})
    public static void createAdapter(final RecyclerView list,
